...
[![My Skills](https://skillicons.dev/icons?i=python,java,js,react,next,nodejs,express,flask,mysql,mongodb,postgres,redis,sqlite,firebase,docker,aws,git,postman,html,css,php,c&theme=dark)](https://skillicons.dev)
